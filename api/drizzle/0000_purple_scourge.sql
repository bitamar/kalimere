...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "visit_notes" ADD CONSTRAINT "visit_notes_visit_id_visits_id_fk" FOREIGN KEY ("visit_id") REFERENCES "public"."visits"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "appointment_pet_idx" ON "appointments" USING btree ("pet_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "appointment_customer_idx" ON "appointments" USING btree ("customer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "customer_user_idx" ON "customers" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "customers_user_id_phone_unique" ON "customers" USING btree ("user_id","phone");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pet_customer_idx" ON "pets" USING btree ("customer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "session_user_idx" ON "sessions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "treatment_user_idx" ON "treatments" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "visit_treatment_visit_idx" ON "visit_treatments" USING btree ("visit_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "visit_treatment_treatment_idx" ON "visit_treatments" USING btree ("treatment_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "visit_note_visit_idx" ON "visit_notes" USING btree ("visit_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "visit_pet_idx" ON "visits" USING btree ("pet_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "visit_customer_idx" ON "visits" USING btree ("customer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "visit_status_idx" ON "visits" USING btree ("status");
